  ...
  <header className="sticky top-0 z-50 w-full border-b-2 border-[#30435D]/45 bg-white shadow-[0_10px_35px_rgba(15,23,42,0.06)]">
      <div className="mx-auto flex min-h-[74px] max-w-7xl items-center justify-between gap-3 px-4 md:px-6 xl:px-8">
        <button
          ...
          className={`group flex min-w-0 shrink-0 touch-manipulation cursor-pointer items-center rounded-2xl outline-none transition-all duration-300 hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-[#86CDFC] focus-visible:ring-offset-2 active:scale-[0.98] ${
        ...
        >
          <img
            src="/images/logo.png"
            alt="Bi Ne Bianni"
            className={`h-10 w-auto max-w-[145px] object-contain transition-all duration-300 group-hover:opacity-90 sm:h-11 sm:max-w-[175px] md:max-w-[125px] lg:max-w-[150px] xl:h-12 xl:max-w-[205px] ${
              botonPresionado === "inicio" ? "scale-[0.98] opacity-90" : ""
            }`}
          />
        </button>
            ...
            {links.map((link) => {
              ...
              return (
                <button
                  ...
                  className={`group/link shrink-0 touch-manipulation cursor-pointer whitespace-nowrap rounded-full border px-3 py-2 text-xs font-bold outline-none transition-all duration-300 focus-visible:ring-2 focus-visible:ring-[#86CDFC] focus-visible:ring-offset-2 active:scale-95 xl:px-5 xl:py-2.5 xl:text-sm ${
                    activo
        ...
        <button
          ...
          className={`group relative inline-flex shrink-0 touch-manipulation cursor-pointer items-center justify-center overflow-hidden rounded-full border border-[#30435D]/15 bg-[#30435D] px-3.5 py-2.5 text-[10px] font-black uppercase tracking-[0.12em] text-white shadow-lg shadow-[#30435D]/20 outline-none transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#26364c] hover:shadow-xl hover:shadow-[#30435D]/25 focus-visible:ring-2 focus-visible:ring-[#86CDFC] focus-visible:ring-offset-2 active:translate-y-0 active:scale-95 sm:px-5 sm:py-3 sm:text-[11px] ${
        ...
        >
          ...
          <span className="relative flex items-center gap-2 whitespace-nowrap">
            ...
            <span
              className={`grid size-4 place-items-center rounded-full text-[9px] leading-none transition-all duration-300 sm:size-5 sm:text-[10px] ${
                botonPresionado === "contacto"
                  ? "bg-[#86CDFC] text-[#30435D]"
                  : "bg-white/15 text-white group-hover:translate-x-0.5 group-hover:bg-white/20"
              }`}
            >
              →
            </span>
