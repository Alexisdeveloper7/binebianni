  ...
  return (
    <section className="relative -mt-px -mb-px overflow-hidden bg-[#e4f5ff] px-4 py-3 md:px-8 md:py-3">
      <div className="relative z-10 mx-auto grid max-w-6xl gap-3 md:grid-cols-2 md:gap-4">
        <div className="group touch-manipulation relative cursor-pointer overflow-hidden rounded-[1.25rem] border border-[#86CDFC]/45 bg-[#f4fbff] p-4 shadow-none ring-1 ring-white/80 transition-all duration-300 hover:-translate-y-1 hover:border-[#86CDFC]/80 hover:bg-white hover:shadow-none md:rounded-[1.75rem] md:p-6">
      ...
      <div className="relative left-1/2 z-10 mt-5 w-screen -translate-x-1/2 px-2 md:left-auto md:mx-auto md:mt-7 md:w-[75%] md:max-w-3xl md:translate-x-0 md:px-0 lg:max-w-3xl">
        <div className="group relative cursor-pointer overflow-hidden rounded-[1rem] border border-[#86CDFC]/45 bg-[#f4fbff] p-1 ring-1 ring-white/80 md:rounded-[1.6rem] md:p-2">
