const servicios = [
  {
    ...
    texto:
      "Elaboración de estudios sociales para identificar impactos, riesgos y oportunidades asociados al desarrollo de proyectos.",
  ...
  },
  {
    ...
    texto:
      "Diseño e implementación de estrategias orientadas a gestionar impactos sociales y fortalecer la sostenibilidad de los proyectos.",
  ...
  },
  {
    ...
    texto:
      "Acompañamiento técnico en procesos participativos con enfoque intercultural y respeto a los derechos colectivos.",
  ...
  },
  {
    ...
    texto:
      "Diseño de estrategias para fortalecer el diálogo y la construcción de confianza con comunidades y grupos de interés.",
  ...
  },
  {
    ...
    texto:
      "Identificación, caracterización y análisis de actores clave para la gestión territorial.",
  ...
  },
  {
    ...
    texto:
      "Diseño e implementación de sistemas de atención, seguimiento y resolución de inquietudes comunitarias.",
  ...
  },
  {
    ...
    texto:
      "Análisis social, económico y cultural para apoyar la toma de decisiones estratégicas.",
  ...
  },
  {
    ...
    texto:
      "Integración de criterios ambientales, sociales y de gobernanza en proyectos y organizaciones.",
  ...
  },
  {
    ...
    texto:
      "Seguimiento de indicadores y desempeño social para evaluar resultados e impactos.",
  ...
  },
  {
    ...
    texto:
      "Diseño e implementación de programas orientados a generar valor compartido y fortalecer el desarrollo comunitario.",
...
const posicionesXL = [
  ...
  "xl:col-start-7 xl:row-start-2",

  "xl:col-start-2 xl:row-start-3",
  "xl:col-start-4 xl:row-start-3",
  "xl:col-start-6 xl:row-start-3",
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mx-auto mt-7 grid max-w-[880px] gap-3.5 md:mt-9 md:grid-cols-[repeat(2,minmax(0,420px))] md:justify-center md:gap-4 xl:max-w-[1180px] xl:grid-cols-8 xl:gap-4">
          {servicios.map((servicio, index) => {
            return (
              <article
                key={servicio.titulo}
                className={`group relative mx-auto aspect-[3/2] w-full max-w-[360px] cursor-pointer overflow-hidden rounded-[1.2rem] border border-[#86CDFC]/45 bg-[#eaf4ff] shadow-none ring-1 ring-white/80 transition-all duration-300 hover:-translate-y-1 hover:border-[#86CDFC]/80 hover:shadow-none active:scale-[0.98] min-[390px]:max-w-[375px] min-[430px]:max-w-[390px] sm:max-w-[480px] md:max-w-none md:rounded-[1.65rem] xl:col-span-2 xl:mx-0 xl:max-w-none ${
                  posicionesXL[index]
                }`}
              >
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#172338]/90 via-[#172338]/50 to-[#172338]/5" />
                ...
                <div className="absolute inset-x-0 top-0 h-28 bg-gradient-to-b from-black/45 to-transparent md:h-32" />

                <div className="relative z-10 flex h-full flex-col items-start justify-start p-3.5 text-left text-white md:p-5 xl:p-3.5">
